...
async def on_chat_start():
    model = ChatGoogleGenerativeAI(model='gemini-pro', streaming=True,convert_system_message_to_human=True, safety_settings=safety_settings=safety_settings)
    model_vision = ChatGoogleGenerativeAI(model='gemini-pro-vision', streaming=True,convert_system_message_to_human=True, safety_settings=safety_settings=safety_settings)
